...
| Phase 7: Digger crew | Unstarted | Digger roles, zone reservations, tunnel jobs, destructive approval gates. |
| Phase 8: AI planner | Unstarted | Reusable plan authoring, AI-drafted template review, structured planning responses, job previews. |
| Phase 9: Coaster prototype | Unstarted | Short tunnel, track placement, detector trigger, tester ride log. |
